...
/*************************************************************
 * USART Status Register (SR) - bit positions and masks
 *************************************************************/
...
/*************************************************************
 * USART CR1 bit positions and masks (use POS for shifting
 * and USE *_MASK when you want a mask)
 *************************************************************/
 ...
 *************************************************************/
#define USART_CR2_STOP                      12U  /* STOP bits start at bit 12 */

/*************************************************************
 * USART CR3 bit positions and masks
 *************************************************************/
...
#define USART_FLAG_TXE   (1U << 7)   // Transmit Data Register Empty
#define USART_FLAG_TC    (1U << 6)   // Transmission Complete
#define USART_FLAG_RXNE  (1U << 5)   // Read Data Register Not Empty
#define USART_FLAG_IDLE  (1U << 4)   // IDLE line detected
#define USART_FLAG_ORE   (1U << 3)   // Overrun error
#define USART_FLAG_NE    (1U << 2)   // Noise error
#define USART_FLAG_FE    (1U << 1)   // Framing error
#define USART_FLAG_PE    (1U << 0)   // Parity error
