...
/*
 * NVIC Interrupt Priority Levels (0-15)
 * Lower number = Higher priority
 * STM32F446RE implements 4 bits for priority (16 levels: 0-15)
 */
 ...
 */
#define GPIO_AF0_SYSTEM         	(0)     /* System alternate function */
#define GPIO_AF1_TIM1_2         	(1)     /* TIM1, TIM2 */
#define GPIO_AF2_TIM3_5         	(2)     /* TIM3, TIM4, TIM5 */
#define GPIO_AF3_TIM8_11        	(3)     /* TIM8, TIM9, TIM10, TIM11 */
#define GPIO_AF4_I2C            	(4)     /* I2C1, I2C2, I2C3 */
#define GPIO_AF5_SPI            	(5)     /* SPI1, SPI2, SPI3, SPI4 */
#define GPIO_AF6_SPI3           	(6)     /* SPI2, SPI3, SAI1 */
#define GPIO_AF7_USART          	(7)     /* USART1, USART2, USART3 */
#define GPIO_AF8_UART           	(8)     /* UART4, UART5, USART6 */
#define GPIO_AF9_CAN_TIM        	(9)     /* CAN1, CAN2, TIM12, TIM13, TIM14 */
#define GPIO_AF10_OTG_FS        	(10)    /* OTG_FS, OTG_HS */
#define GPIO_AF11_ETH           	(11)    /* Ethernet */
#define GPIO_AF12_FMC_SDIO      	(12)    /* FMC, SDIO, OTG_HS */
#define GPIO_AF13_DCMI          	(13)    /* DCMI */
#define GPIO_AF14_LTDC          	(14)    /* LTDC (not on F446) */
#define GPIO_AF15_EVENTOUT      	(15)    /* EVENTOUT */
